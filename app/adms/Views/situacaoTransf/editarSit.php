...
<div class="content p-1">
    <div class="list-group-item">
        <div class="d-flex">
            ...
            ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'ver-sit-transf/ver-sit/' . $valorForm['id']; ?>" class="btn btn-outline-primary btn-sm">Visualizar</a>
                </div>
            <?php
            }
            ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input name="nome" type="text" class="form-control" placeholder="Nome da situação" value="
                    <?php
